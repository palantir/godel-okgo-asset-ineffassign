...
import (
	"github.com/palantir/godel-okgo-asset-ineffassign/ineffassign/config/internal/legacy"
	v0 "github.com/palantir/godel-okgo-asset-ineffassign/ineffassign/config/internal/v0"
